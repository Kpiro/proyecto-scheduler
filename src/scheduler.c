                   ...
                   int curr_pid)
{
  ...
  // 1.Bajarle la prioridad si el proceso que se ejecutó anteriormente no ha terminado
  if (curr_pid != -1)
  {
  ...
  // 2.Procesos nuevos (insertar todos los procesos que entraron en este interrupt_time en la cola de mayor prioridad)
